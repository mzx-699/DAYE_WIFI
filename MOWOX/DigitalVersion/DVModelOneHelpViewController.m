//
//  DVModelOneHelpViewController.m
//  digitalVersionTest
//
...
@interface DVModelOneHelpViewController ()
...
@implementation DVModelOneHelpViewController
...
- (UILabel *)detailLabel{
    if (!_detailLabel) {
        ...
        _detailLabel.text = @"more compatible to 2.4GHZ Wifi network,more convenient on operation";
